...
function drawChart(history, forecast, high, low) {
    ...
    const pad = Array(history.length).fill(null);
    ...
    chart = new Chart(ctx, {
        ...
        data: {
            labels,
            datasets: [
                { label: "Actual Players", data: history, borderColor: "#76b3ff", borderWidth: 3, tension: 0.3 },
                { label: "Forecast", data: forecastShifted, borderColor: "#55ff99", borderDash: [6, 6], borderWidth: 3, tension: 0.3 },
                { label: "High", data: highShifted, borderColor: "#ffcc33", borderDash: [6, 6], tension: 0.3 },
                { label: "Low", data: lowShifted, borderColor: "#ff6666", borderDash: [6, 6], tension: 0.3 },
            ]
        }
    });
}
